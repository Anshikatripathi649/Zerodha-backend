...
function Hero() {
    return ( 
        <div className='container p-4 '>
            <div className='row p-4 border-bottom mb-5' style={{textAlign:"center"}}>
            ...
            <div className="row mt-5 px-5 mb-0"
                 style={{lineHeight:"1.8", color:"#424242"}}>
                <div className="col fs-5 m-4">
                    <p> 
